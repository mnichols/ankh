...
/**
 * Graph an array of arrays of strings, like an array of `inject` settings.
 * @method graph
 * @example
 * ```js
 * var out = registrations.graph([ ['a','b'],['b','c'],['a']]) ->
 * console.log(out) -> ['c','a','b']
 * ```
 * @return {Array} of unique strings preserving the valid execution order
 * */
Registrations.prototype.graph = function(arrays) {
    arrays = (arrays || [])

    //this is vertices of the inject statements
    var vertices = toposort(arrays)
