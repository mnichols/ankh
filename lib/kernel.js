                ...
                .map(function(model){
                    return this.resolve(model.key)
                        .then(function(instance){
                            var fn = instance[model.startable].bind(this)
